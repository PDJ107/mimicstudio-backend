...
operation::members-signup[snippets='request-fields,http-request,response-fields,http-response']
...
operation::members-login[snippets='request-fields,http-request,response-fields,http-response']
